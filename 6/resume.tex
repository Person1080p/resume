...
\noindent \textbf{Technologies: } Linux, VSCode, Azure Devops, JFrog, Openshift, Google Kubernetes Engine, Docker, Jenkins, SonarQube, NGINX, systemD, VirtualBox, Windows Server, OWASP ZAP\\ \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WORK EXPERIENCE
