...
\textit{Software Development Engineer I, DCT-BV/CETD/CVD, Promotion} \hfill August, 2022 $-$ Present
...
\end{itemize}\textit{Engineering Major Co-Op, DCT-BV}
\begin{itemize}[noitemsep,nolistsep,leftmargin=*]
...
\begin{itemize}[noitemsep,nolistsep,leftmargin=*]
\item {Taught fellow students how to setup a virtual environment to run a Linux virtual machine}
