...
\begin{itemize}[noitemsep,nolistsep,leftmargin=*]
\item {Created a small personal website using regular HTML+CSS+JS hosted on my home network}
...
\item {Managed all speakers with the tech talks and having the live streams run smoothly}
